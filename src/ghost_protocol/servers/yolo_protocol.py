...
from src.ghost_protocol.models.models import YOLOMission, CodeDelta, MissionPlan, NarrativeEntry, Dilemma, MissionMemory
...
class YOLOEngine:
    ...
    async def _execute_generation_step(self, step_id: str, parameters: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from src.ghost_protocol.models.models import WeaverRequest
