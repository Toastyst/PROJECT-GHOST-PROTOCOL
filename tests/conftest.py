...
def isolated_yolo(temp_chroma_db, mock_openai):
    ...
    from src.ghost_protocol.servers.yolo_protocol import YOLOServer
...
def cleanup_ghost_instances():
    ...
    from src.ghost_protocol.servers.nexus_server import nexus_instance
    from src.ghost_protocol.servers.weaver_server import weaver_instance
    from src.ghost_protocol.servers.yolo_protocol import yolo_instance
